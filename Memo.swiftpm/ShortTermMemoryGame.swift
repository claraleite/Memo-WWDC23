...
struct ShortTermMemoryGame: View {
    
    @State private var monsters: [String] = ["purple-monster", "blue-monster", "pink-monster", "red-monster", "green-monster", "orange-monster", "yellow-monster"].shuffled()
    ...
    @State private var rectangles = [String](repeating: "rectangle", count: 7)
    ...
    var body: some View {
        ...
        GeometryReader { geometry in
            ...
            ZStack {
                BackgroundViewModel(imageName: "bg-first-game")
                ...
                if countView > 0 && countView != 2 {
                    ...
                    VStack {
                        ...
                        Text(countView == 3 ? "Now, TAP each item to position it how you memorized." : "Memorize where each item is. You have 10 seconds.")
                            .frame(width: countView == 3 ? geometry.size.width * 0.8 : geometry.size.width * 0.4)
                            .font(.system(size: 32, weight: .semibold, design: .default))
                ...
                NavigationButtonViewModel(nextView: ShortTermMemoryFeedback(numberOfPoints: endGame()), text: "DONE")
    ...
    func itemDismissed(monsterIndex: Int, monsterName: String) {
        ...
        rectangles[currentRectangleIndex - 1] = "rectangle"
    ...
    func endGame() -> Int {
        ...
        if monstersChosen.count == 7 {
            for index in 0...6 {
                if monstersChosen[index] == monsters[index] {
                    correctAnswers += 1
                }
            } 
        }
...
struct ShortTermMemoryGame_Previews: PreviewProvider {
